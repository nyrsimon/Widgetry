  ...
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <div class="m-2">
        ...
        <div class="mt-5 flex flex-row bg-gray-200 h-14 align-middle">
          ...
          <input type="text" placeholder="Email Address" class="text-2xl bg-gray-200">
        </div>
        <div class="mt-5 flex flex-row bg-gray-200 h-14 align-middle">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="w-8 h-8 mt-2 mr-3 ml-3">
          ...
          <input type="text" placeholder="Password" class="text-2xl bg-gray-200">
        </div>
      </div>
    </ion-content>
  </ion-page>
